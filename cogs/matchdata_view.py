...
class ValidateStatsView(discord.ui.View):
    ...
    @discord.ui.button(label=f'{self.username}', style=discord.ButtonStyle.primary)
    async def username_button(self, inter: discord.Interaction, button: discord.ui.Button[ValidateStatsView]) -> None:
